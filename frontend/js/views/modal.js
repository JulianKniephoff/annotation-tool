...
define([
    ...
    var Modal = Backbone.View.extend({
        ...
        className: function () {
            return (this.additionalClassName || "") + " modal";
        },

        attributes: function () {
            return _.extend({ tabindex: -1 }, this.additionalAttributes);
        },
        ...
        initialize: function (options) {
            ...
            if (this.hidden) {
                this.$el.on("hidden", _.bind(this.hidden, this));
            }
        },

        remove: function () {
            this.$el.on("hidden", _.bind(Backbone.View.prototype.remove, this));
            this.hide();
        }
    });
