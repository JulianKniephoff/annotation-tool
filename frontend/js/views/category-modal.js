...
define([
    ...
    var CategoryModal = Modal.extend({
        ...
        render: function () {
            ...
            var affiliation = this.model.get("seriesCategoryId") ? "series" : "event";
        ...
        events: {
            ...
            "submit form": function (event) {
                ...
                // TODO UGH
                var seriesExtId;
                $.when(annotationTool.getSeriesExtId()).done(function (id) {
                    seriesExtId = id;
                });
                var seriesCategoryId = this.model.get("seriesCategoryId") || this.model.id;
                // TODO Async?
                this.model.save({
                    ...
                    seriesCategoryId: affiliation === "series" ? seriesCategoryId : "",
                    ...
                    seriesExtId: affiliation === "series" ? seriesExtId : ""
                });
