...
public class ExtendedAnnotationServiceJpaImplTest {
  ...
  public void testCreateCategory() {
    ...
    final Category c = eas.createCategory(some(3L), some("seriesId"), none(), some(32L), "Verhalten", some("verhalten "),
            some("settings"), resource);
    assertEquals(tags.get(), c.getTags());
    Option<Category> cCopy = eas.createCategoryFromTemplate(20, "SeriesId", 1337L, categoryTemplate.getId(), resource);
  ...
  public void testUpdateCategory() {
    ...
    expectCause(Cause.NOT_FOUND, new Effect0() {
      @Override
      protected void run() {
        eas.updateCategory(new CategoryImpl(1212, some(323L), some("seriesId"), none(), some(32L), "bla", none(), none(), resource));
      }
    });
    // create
    final Category c = eas.createCategory(none(), some("seriesId"), none(), none(), name, some("description Sozialform"),
    ...
    eas.updateCategory(new CategoryImpl(c.getId(), some(323L), some("seriesId"), none(), some(32L), "name2", none(), none(), updatedResource));
  ...
  public void testDeleteCategory() {
    ...
    final Resource resource = eas.createResource();
    // create
    final Category c = eas.createCategory(none(), some("seriesId"), none(), none(), "Sozialform",
            some("description Sozialform"), some("sozial form settings"), resource);
    assertTrue(eas.getCategory(c.getId(), false).isSome());
    // delete
  ...
  public void testUpdateLabel() {
    ...
    expectCause(Cause.NOT_FOUND, new Effect0() {
      @Override
      protected void run() {
        eas.updateLabel(new LabelImpl(323, 29, none(), "test", "i dont know", none(), none(), resource));
      }
    });
    // create
    ...
    final Resource updatedResource = eas.updateResource(resource, tags);
    eas.updateLabel(new LabelImpl(l.getId(), 11, none(), "test", "i dont know", none(), none(), updatedResource));
